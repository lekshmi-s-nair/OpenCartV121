...
public class ExtentReportManager implements ITestListener {
	 ...
	 * extent.createTest(result.getName()); test.log(Status.INFO, "********** " +
	 * result.getName() + " Started **********"); }
	 */
	...
	public void onFinish(ITestContext context) {
		 ...
		 * 
		 * // Replace with your Gmail and App Password email.setAuthenticator( new
		 * DefaultAuthenticator( "yourgmail@gmail.com", "your_app_password"));
		 * 
		 * email.setSSLOnConnect(true);
		 * 
		 * email.setFrom("yourgmail@gmail.com"); // Sender
		 * email.setSubject("Test Results");
		 * email.setMsg("Please find attached report...");
		 * 
		 * email.addTo("lexnair1806@gmail.com"); // Receiver
		 * 
